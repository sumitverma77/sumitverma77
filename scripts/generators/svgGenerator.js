            ...
            <style>
                ...
                * { font-family: 'Share Tech Mono', monospace; }
                ...
                @keyframes pulse-anim {
                    0% { filter: drop-shadow(0 0 2px ${colors.magenta}); }
                    50% { filter: drop-shadow(0 0 8px ${colors.magenta}); }
                    100% { filter: drop-shadow(0 0 2px ${colors.magenta}); }
                }
...
export function generateContributionHistorySvg(stats, theme = 'dark') {
  ...
  <title id="t">Sumit Verma (sumitverma77) Contribution History (${theme})</title>
  <desc id="d">GitHub contribution details and activity history</desc>
  <defs>
    <style>
      @import url('https://fonts.googleapis.com/css2?family=Share+Tech+Mono&amp;display=swap');
      .bg { fill: ${bgColor}; stroke: ${borderColor}; stroke-width: 1.5; }
      .title { font: bold 22px -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif; fill: ${titleColor}; }
      .label { font: 14px -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif; fill: ${labelColor}; }
      .subtext { font: 11px ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; fill: ${subtextColor}; }
      .axis { stroke: ${axisColor}; stroke-width: 1; }
      .icon { fill: ${iconColor}; }
